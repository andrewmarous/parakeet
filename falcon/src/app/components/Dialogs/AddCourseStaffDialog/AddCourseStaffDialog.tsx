...
export function AddCourseStaffDialogContent() {
  return (
    <DialogContent className="w-[28rem]">
      ...
      <div className="mt-1 font-semibold text-lg">
        <h3>Add a Course Staff</h3>
        <p className="font-normal text-sm text-grey-600 mt-1">
          Enter information about your course staff.
        </p>
      </div>
      <div>
        {/* <AddCourseStaffForm /> */}
...
export default function AddCourseStaffDialog() {
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="secondary">
          Add Course Staff <FaPlus />
        </Button>
      </DialogTrigger>
      <AddCourseStaffDialogContent />
    </Dialog>
  );
}
